...
`;
			...
			/* eslint-disable @typescript-eslint/no-unsafe-assignment, @typescript-eslint/naming-convention, @typescript-eslint/no-unsafe-call */
			const { View } = await import(FULL_FILE_PATH);
			const VIEW: AbstractView = <AbstractView> new View(parameters);
			/* eslint-enable @typescript-eslint/no-unsafe-assignment, @typescript-eslint/naming-convention, @typescript-eslint/no-unsafe-call */
